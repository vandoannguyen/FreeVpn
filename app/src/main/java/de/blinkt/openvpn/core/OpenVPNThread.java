...
//            Log.e(TAG, "OpenVPNThread Got " + e.toString());
            ...
            if (mDumpPath != null) {
                try {
                    ...
                    logout.close();
//                    Log.e(TAG,R.string.minidump_generated);
                } catch (IOException e) {
                    Log.e(TAG,"Writing minidump log: " + e.getLocalizedMessage());
                }
            }
        ...
        try {
            ...
            while (true) {
                ...
                if (m.matches()) {
                    ...
                    if (logerror == 1) {
                        Log.e(TAG,"OpenSSL reproted a certificate with a weak hash, please the in app FAQ about weak hashes");
                    }
                } else {
