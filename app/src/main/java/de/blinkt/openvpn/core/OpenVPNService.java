...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            Log.e("app_param_error", params.toString());
        }
        ...
        try {
            ConnectionTimer = new CountDownTimer(86400_000, 1000) {
                public void onTick(long millisUntilFinished) {
                    ...
                    Config.StringCountDown = String.format(getString(R.string.string_of_two_number), (long_milli_seconds / (1000 * 60 * 60)) % 24) + ":" +
        ...
        if (intent != null && intent.hasExtra(getPackageName() + ".profileUUID")) {
            ...
            Log.e(TAG, getString(R.string.service_restarted));
...
//        }
    ...
    private void startOpenVPN() {
        Log.e(TAG, getString(R.string.building_configration));
...
//        if (!"ovpn3".equals(BuildConfig.FLAVOR))
        ...
        if (!mOvpn3) {
            ...
            if (ovpnManagementThread.openManagementInterface(this)) {
                ...
                Log.e(TAG, "started Socket Thread");
            } else {
                endVpnService();
                return;
            }
    ...
    public ParcelFileDescriptor openTun() {
        ...
        Log.e(TAG, getString(R.string.last_openvpn_tun_config));
        ...
        if ((Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT && !release.startsWith("4.4.3") && !release.startsWith("4.4.4") && !release.startsWith("4.4.5") && !release.startsWith("4.4.6")) && mMtu < 1280) {
            Log.e(TAG, String.format(Locale.US, "Forcing MTU to 1280 instead of %d to workaround Android Bug #70916", mMtu));
            builder.setMtu(1280);
        } else {
            builder.setMtu(mMtu);
        }
        ...
        Log.e(TAG, getString(R.string.local_ip_info) + " " + mLocalIP.mIp + " " + mLocalIP.len + " " + mLocalIPv6 + " " + mMtu);
        Log.e(TAG, getString(R.string.dns_server_info) + " " + TextUtils.join(", ", mDnslist) + " " + mDomain);
        Log.e(TAG, getString(R.string.routes_info_incl) + " " + TextUtils.join(", ", mRoutes.getNetworks(true)) + " " + TextUtils.join(", ", mRoutesv6.getNetworks(true)));
        Log.e(TAG, getString(R.string.routes_info_excl) + " " + TextUtils.join(", ", mRoutes.getNetworks(false)) + " " + TextUtils.join(", ", mRoutesv6.getNetworks(false)));
        ...
        if (mDnslist.size() == 0)
            Log.e(TAG, getString(R.string.warn_no_dns));
    ...
    private void setAllowedVpnPackages(Builder builder) {
        ...
        for (String pkg : mProfile.mAllowedAppsVpn) {
            try {
                ...
                Log.e(TAG, getString(R.string.app_no_longer_exists) + " " + pkg);
            }
        }
