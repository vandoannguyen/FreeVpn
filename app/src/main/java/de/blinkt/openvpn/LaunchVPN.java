...
//                    askForPW(needpw);
                    mSelectedProfile.mUsername = new EncryptData().decrypt(getSelectedServer().getAuth().getUsername());
                    mSelectedProfile.mPassword = new EncryptData().decrypt(getSelectedServer().getAuth().getPassword());
                }
//                else {
