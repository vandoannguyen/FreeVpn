...
//                    askForPW(needpw);
                    mSelectedProfile.mUsername = new EncryptData().decrypt(getSelectedServer().getUserName());
                    mSelectedProfile.mPassword = new EncryptData().decrypt(getSelectedServer().getPassword());
                }
//                else {
