package com.freeproxy.vpnmaster.hotspot2.ui.faq;
...
public class ExpandableListDataPump {
    public static HashMap<String, List<String>> getData() {
        ...
        question1.add("Just tap 'GO' button. If it shows 'Connected', it means Secure VPN works. Please tick 'I trust this application' the first time you connect");
        List<String> question2 = new ArrayList<String>();
        question2.add("It's 100% free(no money or credit card needed) forever with unlimited data and time, but P2P or BitTorrent is not allowed. Also, Secure VPN " +
        ...
        question3.add("(3) If it show 'No server available now, please update the APP', you need to update Secure VPN to the latest version. ");
        question3.add("(4) If it shows 'Connecting...' for a long time, you should clean up Secure VPN's APP data, and restart Secure VPN to connect");
        question3.add("(5) If all the above does not work, you can uninstall Secure VPN, and re-install it. Usually it will work well. ");
        ...
        expandableListDetail.put(" What to if Secure VPN doesn't provide the IP, server or resgion you want?", question6);
        expandableListDetail.put(" Is Secure VPN connect?", question2);
        ...
        expandableListDetail.put(" Why can't Secure VPN connect?", question3);
        expandableListDetail.put(" How to use Secure VPN?", question1);
